...
?>
  ...
  <label for="planDisplay">Display Status</label>
  
  <input style="width: 5px;" type="checkbox" name="planDisplay" id="planDisplay"  checked="checked">
    </div>
    <div style="clear:both!important;"></div>    
  ...
  <label for="planShipping">Free Shipping</label>
  
  <input style="width: 5px;" type="checkbox" name="planShipping" id="planShipping"  checked="checked">
    </div>
    <div style="clear:both!important;"></div>    
...
?>
    <table class="form-table">
        ...
        <th scope="row" valign="top">
            <label for="pricetext"><?php _e('Price'); ?></label>
        </th>
        <td>
  ...
  <input type="text" name="pricetext" id="pricetext"  value="<?php echo get_term_meta($tag->term_id, 'priceText', true); ?>">
    ...
    <div style="clear:both!important;"></div>    
        ...
        <tr class="form-field">
        <th scope="row" valign="top">
            <label for="planDisplay"><?php _e('Display Status'); ?></label>
        </th>
        <td>
   
       
   <div style="width:5px!important;">
       <?php $planDisplayValue =  get_term_meta($tag->term_id, 'planDisplay', true); ?>
       <input type="checkbox" name="planDisplay" id="planDisplay" <?php if($planDisplayValue =='on'){ echo 'checked="checked"';}?>  > 
   </div>
     ...
     <div style="clear:both!important;"></div>    
                ...
                <tr class="form-field">
        <th scope="row" valign="top">
            <label for="planShipping"><?php _e('Free Shipping'); ?></label>
        </th>
        <td>
   
       
   <div style="width:5px!important;">
       <?php $planShippingValue =  get_term_meta($tag->term_id, 'planShipping', true); ?>
       <input type="checkbox" name="planShipping" id="planShipping" <?php if($planShippingValue =='on'){ echo 'checked="checked"';}?>  > 
   </div>
...
update_term_meta( $term_id,'planDisplay', $_POST['planDisplay']);
update_term_meta( $term_id,'planShipping', $_POST['planShipping']);
}
