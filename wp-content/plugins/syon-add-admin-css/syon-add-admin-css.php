...
function admin_register_head() {
    ...
    if($_GET['post_type']== 'strength')
        {
          ...
          /*  echo 'alert(jQuery("#planchecklist #plan-0 .selectit").html().replace("No Plan", "All Plan"));';*/
            echo 'var allPaln = jQuery("#planchecklist #plan-0 .selectit").html().replace("No Plan", "All Plan");';
            echo ' jQuery("#planchecklist #plan-0 .selectit").html(allPaln);';
        }
   ...
   if($postType = 'strength' && $_GET['action']=='edit')
   {
      echo '<script>'; 
       ...
       echo ' jQuery("#planchecklist #plan-0").hide();';
      echo '</script>';
   }
}
