    ...
    <form action="<?php echo get_permalink( 124 ); ?>" method="post" id="checkOutForm" name="checkOutForm" onsubmit="return checkCheckoutform(this);">
          ...
          <ul id="rightbarDrop">
             ...
             <div class="grid_10">
              <div class="step5edit"><h4>Shipping Address</h4>
                 <div class="shiping">
                <ul>
                    <li><input type="text" placeholder="First Name" name="shippingFirstName" id="shippingFirstName" value="<?php echo $_SESSION['userdata']["shippingFirstName"] ?>" >
                            
                    </li>
                    <li><input type="text" placeholder="Last Name" name="shippingLastName" id="shippingLastName"  value="<?php echo $_SESSION['userdata']["shippingLastName"] ?>" ></li>
                    <li class="bigArea"><input type="text" placeholder="Address" name="shippingAddress" id="shippingAddress"  value="<?php echo $_SESSION['userdata']["shippingAddress"] ?>" ></li>
                    <li class="smallArea"><input type="text" placeholder="Apt/Suite" name="shippingAptSuite" id="shippingAptSuite"  value="<?php echo $_SESSION['userdata']["shippingAptSuite"] ?>" ></li>
                <li class="smallArea"><input type="text" placeholder="City" name="shippingCity" id="shippingCity"  value="<?php echo $_SESSION['userdata']["shippingCity"] ?>" ></li>
                <li class="smallArea"><div id="shipState" style="width:160px">
                                  <div id="stateBox">
                ...
                <li class="smallArea"><input type="text" placeholder="Zip Code" name="shippingZipCode" id="shippingZipCode" value="<?php echo $_SESSION['userdata']["shippingZipCode"] ?>"></li>
          ...
          <ul id="stateDrop">
              ...
              <div class="step5edit"><h4>Billing Information</h4>
                 <div class="shiping">
                <ul>
                    <li class="bigArea"><input type="text" placeholder="Credit Card Number" name="cardNumber" id="cardNumber" value="<?php echo $_SESSION['userdata']["cardNumber"] ?>" maxlength="19"></li>
                <li class="smallArea "><input type="text" placeholder="CVV" name="cardCVV" id="cardCVV" value="<?php echo $_SESSION['userdata']["cardCVV"] ?>" maxlength="4"></li>
                <input type="hidden"  name="cardExpMonth" id="cardExpMonth" value="<?php if($_SESSION['userdata']["cardExpMonth"]!=""){ echo $_SESSION['userdata']["cardExpMonth"]; } else { echo "01"; } ?>" >
          ...
          <ul id="dateDrop">
              <li><a href="javascript:void(0);" class="Drop boxSizing" id="cardMonthBox" ><?php if($_SESSION['userdata']["cardExpMonth"]!=""){ echo $_SESSION['userdata']["cardExpMonth"]; } else { echo "01"; } ?></a>
          ...
          <ul id="dateDrop">
              <?php $year = date('Y'); 
                    $maxYear = $year+15;
                  ?>
              <li id="cardYearLi"><a href="javascript:void(0);" class="Drop boxSizing" id="cardYearBox"><?php if($_SESSION['userdata']["cardExpYear"]!=""){ echo $_SESSION['userdata']["cardExpYear"]; } else { echo $year; } ?></a>
                 ...
                 <div class="shiping">
                <ul>
                    <li class="bigArea"><input type="text" placeholder="Address" name="billingAddress" id="billingAddress" value="<?php echo $_SESSION['userdata']["billingAddress"] ?>"></li>
                    <li class="smallArea"><input type="text" placeholder="Apt/Suite" name="billingAptSuite" id="billingAptSuite" value="<?php echo $_SESSION['userdata']["billingAptSuite"] ?>"></li>
                    <li class="smallArea"><input type="text" placeholder="City" name="billingCity" id="billingCity" value="<?php echo $_SESSION['userdata']["billingCity"] ?>"></li>
                    <input type="hidden"  name="billingState"   id="billingState"     value="" >
                    <input type="hidden"  name="billingCountry" id="billingCountry"   value="" >
                <li class="smallArea">
                	<div  style="width:160px"><div id="billingStateText"> </div></div>
                </li>
                  <li class="smallArea"><input type="text" placeholder="Zip Code" name="billingZipCode" id="billingZipCode" value="<?php echo $_SESSION['userdata']["billingZipCode"] ?>"></li>
                <li class="bigArea" style="margin-left:10px;"><div class="stateDrop">
...
<script>
  ...
  //$('#stateBox div ul li').keypress(function(event) { alert("key press"); return event.keyCode != 13; });
...
<style>
  ...
  .minict_wrapper:after { right:54px !important;}
</style>
	...
	$.ajax({
      ...
      function getCountryId(countryid)
      {
        ...
        //$('#shipState').text('State');
          ...
          var data = { countryid: countryidarray[1], divid: "shipState", currentSelected:"<?php if($_SESSION['userdata']["shippingState"]!=""){ echo $_SESSION['userdata']["shippingState"]; } else { echo ""; } ?>"  };
	$.ajax({
            type	: "POST",
            cache	: false,
            url     : ajaxurl,
      ...
      function getbillingCountryId(countryid)
      {
        var countryidarray = countryid.split('~');
          ...
          var data ={ countryid: countryidarray[1], divid: "billingStateText",currentSelected:"<?php if($_SESSION['userdata']["billingState"]!=""){ echo $_SESSION['userdata']["billingState"]; } else { echo ""; } ?>"   };
        $.ajax({
            type	: "POST",
            cache	: false,
            url     : ajaxurl,
      ...
      function callSameAddress()
      {
       ...
       if(checkAdress == 0)
		...
		$('#billingstatedrop_select').val(getShipStatearray[0]+"~"+getShipStatearray[1]+"~"+"billingStateText");
...
*/		
		...
		callShipState($('#billingstatedrop_select').val().trim());
        var billingState        = $('#billingState').val().trim();
/*		var billingState        = callShipState($('#billingstatedrop_select').val().trim());
 ...
 if (userPasswordtext != "")
    {   
        if(userPasswordtext.length < 7 )
                {
                     showCheckOutMsg('userPasswordtext','Password must be at least 7 characters');                 
                     errors[errors.length] =as++;
                }
    }
        <?php } ?>
