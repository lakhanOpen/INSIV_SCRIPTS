...
<style>
  ...
  #billingStateText{
    ...
    if(userEmailAdress == "" )
    {
           showCheckOutMsg('userEmailAdress','Enter E-mail Address');                 
           errors[errors.length] =as++;
    }
    ...
    if(userEmailAdress !="")
    {
        if (!echeck(userEmailAdress)) {
           showCheckOutMsg('userEmailAdress','Enter Vaild E-mail Address');                 
           errors[errors.length] =as++;
        }
    }
 ...
 if (userPasswordtext != "")
    {   
        if(userPasswordtext.length < 9 )
                {
                     showCheckOutMsg('userPasswordtext','Password must be 9 characters');                 
                     errors[errors.length] =as++;
                }
    }
        <?php } ?>
