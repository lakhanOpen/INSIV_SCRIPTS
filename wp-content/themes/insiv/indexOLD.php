...
<div class="sliderBg">
    <div class="container_12">
        <div class="slideTxt">      
            ...
            <p>The best e-liquid flavors delivered to your <br>doorstep.</p>
    ...
    if(!empty($myposts)){
        ...
        <div class="itworkBlog">     
            <div class="grid_4 omega"> 
                ...
                <div class="clear"></div>  
                <div class="worktext">
                    <h4><?php echo $myposts['0']->post_title; ?></h4>  
                    <p><?php echo $myposts['0']->post_content; ?></p> 
                </div> 
            </div>  
        </div>    
        <div class="itworkBlog">  
            <div class="grid_4 alpha omega">  
                ...
                <div class="clear"></div>   
                <div class="worktext">
                   <h4><?php echo $myposts['1']->post_title; ?></h4>  
                    <p><?php echo $myposts['1']->post_content; ?></p> 
                </div>  
            </div>
        </div>   
        <div class="itworkBlog">  
            <div class="grid_4 alpha">   
                ...
                <div class="clear"></div> 
                <div class="worktext">
                   <h4><?php echo $myposts['2']->post_title; ?></h4>  
                    <p><?php echo $myposts['2']->post_content; ?></p> 
                </div>
            </div> 
        </div>
