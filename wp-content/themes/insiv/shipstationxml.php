...
foreach($queryArray as $row)
{
   ...
   $planArray[$as]['OrderTotal']        = get_term_meta( $getPlanArray->term_id, 'priceText', true);
   ...
   $planArray[$as]['item']['UnitPrice']=get_term_meta( $getPlanArray->term_id, 'priceText', true);
